...
<body>
	...
	<article>
		...
		<div class="dropdown">
		<p style="text-align:center;font-size:25px;display:inline;">수신 업무</p>
			  ...
			  <c:forEach items="${menuDP}" var="list">
			    <li><a class="dropdown-item" value="001" onClick="deposit('${list.middle_cd}')">${list.middle_desc}</a></li>
			  </c:forEach></ul>
			</div>
